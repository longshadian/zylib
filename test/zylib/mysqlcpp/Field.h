...
public:
    ...
    uint8 GetUInt8() const
    {
        ...
        {
            FAKE_LOG_ERROR() << "Warning: GetUInt8() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    int8 GetInt8() const
    {
        ...
        if (!IsType(MYSQL_TYPE_TINY))
        {
            FAKE_LOG_ERROR() << "Warning: GetInt8() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    uint16 GetUInt16() const
    {
        ...
        {
            FAKE_LOG_ERROR() << "Warning: GetUInt16() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    int16 GetInt16() const
    {
        ...
        if (!IsType(MYSQL_TYPE_SHORT) && !IsType(MYSQL_TYPE_YEAR))
        {
            FAKE_LOG_ERROR() << "Warning: GetInt16() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    uint32 GetUInt32() const
    {
        ...
        {
            FAKE_LOG_ERROR() << "Warning: GetUInt32() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    int32 GetInt32() const
    {
        ...
        if (!IsType(MYSQL_TYPE_INT24) && !IsType(MYSQL_TYPE_LONG))
        {
            FAKE_LOG_ERROR() << "Warning: GetInt32() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    uint64 GetUInt64() const
    {
        ...
        {
            FAKE_LOG_ERROR() << "Warning: GetUInt64() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    int64 GetInt64() const
    {
        ...
        if (!IsType(MYSQL_TYPE_LONGLONG) && !IsType(MYSQL_TYPE_BIT))
        {
            FAKE_LOG_ERROR() << "Warning: GetInt64() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    float GetFloat() const
    {
        ...
        {
            FAKE_LOG_ERROR() << "Warning: GetFloat() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    double GetDouble() const
    {
        ...
        {
            FAKE_LOG_ERROR() << "Warning: GetDouble() on non-tinyint field " << meta.TableAlias
                << " " << meta.Alias
                << " " << meta.TableName
                << " " << meta.Name
                << " " << meta.Index
    ...
    std::vector<uint8> GetBinary() const
    {
        ...
        std::memcpy(result.data(), data.value, data.length);
        return result;
    }
