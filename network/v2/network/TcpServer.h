...
{
public:
    TcpServer(std::int64_t index, std::shared_ptr<TcpServerEvent> event, MessageDecoderPtr decoder, std::string host, std::uint16_t port, ServerOption option = {});
    ~TcpServer();
...
private:
    std::shared_ptr<TcpServerEvent>     m_event;
